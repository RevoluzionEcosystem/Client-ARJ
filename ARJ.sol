 ...
 * @title ARJ
 * 
 * @notice This is a smart contract developed by Revoluzion for ARJ.
 * 
...
/**
 * @title ARJ Token Contract
 *
 * @notice ARJ is an extended version of ERC-20 standard token that
 ...
 */
contract ARJ is Ownable, IERC20Metadata, IERC20Errors, ICommonError {
    ...
    string private constant NAME = "ARJ token";
    string private constant SYMBOL = "$ARJ";
    ...
    address public projectOwner = 0x9938AB1087a0923e1eA3895B5F0f20337c9CD658;
    address public marketingReceiver = 0x9938AB1087a0923e1eA3895B5F0f20337c9CD658;
    ...
    /**
     * @notice Constructs the ARJ contract and initializes both owner and
     * project owner addresses. Deployer will receive 1,000,000,000 tokens
